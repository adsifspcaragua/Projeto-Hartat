...
// =========================================================
// 1. FAÇA OS IMPORTS DAS IMAGENS AQUI NO TOPO
// Lembre-se de mover as imagens da pasta 'public' para 'src/assets'
// =========================================================
import imgInverno from '../assets/inverno.jpg';
import imgExposicao from '../assets/Exposicao_Obras.JPG';
import imgMundurukuyu from '../assets/MUNDURUKUYU.jpg';
...
const MOCK_EVENTO_SAZONAL = {
  id: 99,
  imagem: imgInverno, // <-- Passando a variável importada sem aspas
...
const DADOS_DESTAQUES = [
  {
    id: 1,
    imagem: imgExposicao, // <-- Passando a variável importada sem aspas
  ...
  {
    id: 2,
    imagem: imgMundurukuyu, // <-- Passando a variável importada sem aspas
    ...
    <main className="pagina-completa-container">
      ...
      <section className="destaques-secao">
        ...
        {eventoSazonal ? (
          ...
          <p>Carregando destaque da estação...</p>
        )}
      </section>
